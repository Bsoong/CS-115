...
Pledge: I pledge my Honor that I hve abided by the Stevens Honor System- Bsoong
'''
...
class HybridCar(Car):  # 2 points
    ...
    5 points'''
    def __init__(self, make, model, tank_capacity, mpg, battery_kWh, miles_per_kWh):  
        super().__init__(make, model, tank_capacity, mpg)
